    ...
    switch (decoded.data.measurements[i].typeName) {
      ...
      case "counter":
        switch (decoded.data.measurements[i].address) {
          case "00":
            data.leftToRight = decoded.data.measurements[i].value;
            break;
          case "01":
            data.rightToLeft = decoded.data.measurements[i].value;
            break;
          case "02":
            data.sumLeftToRight = decoded.data.measurements[i].value;
            break;
          case "03":
            data.sumRightToLeft = decoded.data.measurements[i].value;
            break;
          case "04":
            data.differenceCount = decoded.data.measurements[i].value;
            break;
          default:
            data.status = "Error";
        }
