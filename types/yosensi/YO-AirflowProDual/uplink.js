    ...
    switch (decoded.data.measurements[i].typeName) {
      ...
      case "temperature":
        if (decoded.data.measurements[i].address === "25") {
          data.gasTemperature1 = decoded.data.measurements[i].value;
        } else if (decoded.data.measurements[i].address === "26") {
          data.gasTemperature2 = decoded.data.measurements[i].value;
      ...
      case "pressure":
        if (decoded.data.measurements[i].address === "") {
          data.differentialPressure1 = decoded.data.measurements[i].value;
        } else if (decoded.data.measurements[i].address === "01") {
          data.differentialPressure2 = decoded.data.measurements[i].value;
        }
        break;
      default:
        data.status = "Error";
