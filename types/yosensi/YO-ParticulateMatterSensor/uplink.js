  ...
  for (let i = 0; i < decoded.data.measurements.length; i++) {
    switch (decoded.data.measurements[i].typeName) {
      ...
      case "dust concentration":
        switch (decoded.data.measurements[i].address) {
          case "01":
            data.massConcPm1 = decoded.data.measurements[i].value;
            break;
          case "02":
            data.massConcPm2_5 = decoded.data.measurements[i].value;
            break;
          case "03":
            data.massConcPm4 = decoded.data.measurements[i].value;
            break;
          case "04":
            data.massConcPm10 = decoded.data.measurements[i].value;
            break;
          case "11":
            data.partConcPm1 = decoded.data.measurements[i].value;
            break;
          case "12":
            data.partConcPm2_5 = decoded.data.measurements[i].value;
            break;
          default:
            data.status = "Error";
        }
