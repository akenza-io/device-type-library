    ...
    switch (decoded.data.measurements[i].typeName) {
      ...
      case "state":
        switch (decoded.data.measurements[i].address) {
          case "00":
            data.relayStateCH1 = decoded.data.measurements[i].value;
            break;
          case "01":
            data.relayStateCH2 = decoded.data.measurements[i].value;
            break;
          case "ff":
            data.relayStateAllCH = decoded.data.measurements[i].value;
            break;
          default:
            data.status = "Error";
        }
      ...
      case "custom":
        switch (decoded.data.measurements[i].address) {
          case "00":
            data.outputModeCH1 = decoded.data.measurements[i].value;
            break;
          case "01":
            data.outputModeCH2 = decoded.data.measurements[i].value;
            break;
          case "ff":
            data.outputModeAllCH = decoded.data.measurements[i].value;
            break;
          default:
            data.status = "Error";
        }
