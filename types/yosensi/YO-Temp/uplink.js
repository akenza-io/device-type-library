        ...
        switch(decoded.data.measurements[i].typeName){
            ...
            case 'temperature':
                switch(decoded.data.measurements[i].address){
                    case '00':
                        data.externalTemperature1 = decoded.data.measurements[i].value;
                        break;
                    case '01':
                        data.externalTemperature2 = decoded.data.measurements[i].value;
                        break;
                    case '02':
                        data.externalTemperature3 = decoded.data.measurements[i].value;
                        break;
                    default:
                        /**
                         * No address means internal temperature
                         * */
