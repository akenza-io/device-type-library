  ...
  for (let i = 0; i < decoded.data.measurements.length; i++) {
    switch (decoded.data.measurements[i].typeName) {
      ...
      case "illuminance":
        ...
        break;
      case "counter":
        data.presenceCounter = decoded.data.measurements[i].value;
        break;
      case "Command":
        switch (decoded.data.measurements[i].address) {
          case "07":
            data.comfortSetpoint = decoded.data.measurements[i].value;
            break;
          case "08":
            data.standbyOffset = decoded.data.measurements[i].value;
            break;
          case "09":
            data.economyOffset = decoded.data.measurements[i].value;
            break;
          case "0a":
            data.frostProtSetpoint = decoded.data.measurements[i].value;
            break;
          case "0b":
            data.operationMode = decoded.data.measurements[i].value;
            break;
          case "0c":
            data.getParameters = decoded.data.measurements[i].value;
            break;
          case "0d":
            data.output = decoded.data.measurements[i].value;
            break;
          default:
            data.status = "Error";
        }
