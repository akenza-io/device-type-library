...
function decoder(port, bytes) {
  ...
  for (let i = 0; i < decoded.data.measurements.length; i++) {
    switch (decoded.data.measurements[i].type) {
      case 2:
      ...
      case 25:
        switch (decoded.data.measurements[i].address) {
          case "00":
            data.soilMoisture1 = decoded.data.measurements[i].value;
            break;
          case "01":
            data.soilMoisture2 = decoded.data.measurements[i].value;
            break;
          case "02":
            data.soilMoisture3 = decoded.data.measurements[i].value;
            break;
          default:
            data.status = "Error";
        }
