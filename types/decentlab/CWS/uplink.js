...
function consume(event) {
  ...
  const default_ = {};
  default_.surfaceTemperature = sample.surface_temperature.value;
  ...
  default_.angle = sample.angle.value;
  default_.sensorTemperature = sample.sensor_temperature.value;
