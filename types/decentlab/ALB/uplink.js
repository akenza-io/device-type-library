  ...
  SENSORS: [
    {
      ...
      values: [
        ...
        },
        {
          ...
          displayName: "albedo",
          convert: function (x) {
            return x[0] - 32768 > 0 && x[1] - 32768 > 0
              ? (x[1] - 32768) / (x[0] - 32768)
              : 0;
          },
        },
...
function consume(event) {
  ...
  const data = {};
  data.incomingRadiation = sample.incoming_radiation.value;
  data.reflectedRadiation = sample.reflected_radiation.value;
  data.albedo = sample.albedo.value;
