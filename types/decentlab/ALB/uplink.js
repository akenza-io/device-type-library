...
function consume(event) {
  ...
  const default_ = {};
  default_.incomingRadiation = sample.incoming_radiation.value;
  default_.reflectedRadiation = sample.reflected_radiation.value;
  default_.albedo = sample.albedo.value;
