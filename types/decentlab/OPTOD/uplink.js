...
function consume(event) {
  ...
  default_.oxygenSaturation = sample.oxygen_saturation.value;
  default_.oxygenConcentration = sample.oxygen_concentration.value;
  default_.oxygenConcentrationAlt = sample.oxygen_concentration_alt.value;
