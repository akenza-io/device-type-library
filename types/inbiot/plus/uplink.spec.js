...
describe("inBiot PLUS Uplink", () => {
  ...
  describe("consume()", () => {
    it("should decode the inBiot PLUS sensor payload", () => {
      const data = {
        data: {
          port: 1,
          payloadHex: "0100e90207032f000200000001000100010001ffffffffffff0002504c5553003440314fffff",
        },
      };
      ...
      expectEmits((type, value) => {
        ...
        assert.equal(value.data.type, "PLUS");
        ...
        assert.isUndefined(value.data.o3);
        assert.isUndefined(value.data.no2);
        assert.isUndefined(value.data.co);
