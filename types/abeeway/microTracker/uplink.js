    ...
    case 0x0e: {
      ...
      switch (position) {
        ...
        case 9:
          ...
          data.rssi1 = Bits.bitsToSigned(bits.substring(160, 168));
          // prettier-ignore
          data.bssid2 = `${payload.substring(42, 44)}:${payload.substring(44, 46)}:${payload.substring(46, 48)}:${payload.substring(48, 50)}:${payload.substring(50, 52)}:${payload.substring(52, 54)}`;
          data.rssi2 = Bits.bitsToSigned(bits.substring(216, 224));
          // prettier-ignore
